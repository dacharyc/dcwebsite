...
So hubby and I have just splurged on a [Synology](https://www.synology.com/) (a raid array storage device with redundant drives to back up computers, so even if our computer dies and our backup fails, there's another backup) and we'll be syncing it with [Backblaze](https://www.backblaze.com/) for offsite storage.
