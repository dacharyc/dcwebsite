...
May I present: [Shattered Ring](https://shatteredring.com), the Elden Ring task tracker you didn't know you needed.
...
I wrote this in SwiftUI, using some of the [Realm DB](https://realm.io) Swift SDK goodies that they've written just for SwiftUI. I've complicated my life a little with a data model that means it isn't just a simple build, but I can still use some of the [SwiftUI property wrappers](https://docs.mongodb.com/realm/sdk/swift/examples/swiftui-guide/) and it's pretty magical. And of course, I had to spin up a website for it - which I did in Hugo because it's fast and easy (and not WordPress - really need to migrate this blog). 
